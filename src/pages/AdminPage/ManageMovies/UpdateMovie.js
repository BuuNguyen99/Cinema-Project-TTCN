...
import { actUpdateMovieRequest } from "../../../actions/action";
class UpdateMovie extends Component {
  constructor(props) {
    super(props);
    let updateMovie = JSON.parse(localStorage.getItem("updateMovie"));
    this.state = {
      txtName: {
      ...
      txtSlug: {
        value: updateMovie.slug,
        isInputValid: true,
        errorMessage: "",
      },
      txtIntro: {
        value: updateMovie.intro,
        isInputValid: true,
        errorMessage: "",
      },
      txtType: {
        value: updateMovie.type,
        isInputValid: true,
        errorMessage: "",
      },
      txtAuthor: {
        value: updateMovie.author,
        isInputValid: true,
        errorMessage: "",
      },
      txtActor: {
      ...
      txtTime: {
        value: updateMovie.time,
        isInputValid: true,
        errorMessage: "",
      },
      txtNation: {
        value: updateMovie.nation,
        isInputValid: true,
        errorMessage: "",
      },
      txtPrice: {
        value: updateMovie.price,
        isInputValid: true,
        errorMessage: "",
      },
      txtImage: {
      ...
      txtImageInfo: {
        value: updateMovie.imageInfo,
        isInputValid: true,
        errorMessage: "",
      },
      txtVideoTrailer: {
        value: updateMovie.video,
        isInputValid: true,
        errorMessage: "",
      },
      txtDate: updateMovie.premiereDate,
      rate: updateMovie.vote.rate,
      numberOfReviews: updateMovie.vote.numberOfReviews,
      _id: updateMovie._id,
    };
  }
  ...
  render() {
    ...
    return (
      <div className="container">
        ...
        <form onSubmit={this.onSave} id="updateForm">
...
const mapDispatchToProps = (dispatch) => {
  return {
    onUpdateMovie: (updateMovie) => {
      dispatch(actUpdateMovieRequest(updateMovie));
    },
  };
};

export default connect(null, mapDispatchToProps)(UpdateMovie);
